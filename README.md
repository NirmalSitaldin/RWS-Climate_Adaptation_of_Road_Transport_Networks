...
Our project is segmented in 3 main research areas, in the following sequence: 

1. Risk analysis of the Dutch main road network against climate-change related, unsafe road conditions 
2. Impact assessment of precipitation-based unsafe road conditions on the Dutch main road network 
3. Adaptation modelling of the Dutch main road network to maintain network resilience in the face of climate-change scenario's

The main outcomes of this project, alongside the code repository, can be found in the remainder of this page.

## 📂 Code & Tools

This repository serves as a **hub**. All RWS-related code, data, and analysis can be found in dedicated repositories.  
